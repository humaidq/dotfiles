...
noise='google|gstatic|googleapis|doubleclick|android\.com|facebook|fbcdn|instagram|whatsapp|firebase|appspot|crashlytics|appsflyer|adjust\.|umeng|agora|zego|amazonaws|cloudfront|cloudflare|jsdelivr|unpkg|github|apache\.org|w3\.org|schema\.org|example\.|unity3d|applovin|ironsrc|ironsource|mopub|admob|adcolony|vungle|inmobi|pangle|sentry|bugly|branch\.io|onesignal|jpush|getui|igexin|xiaomi|mi\.com|huawei|hicloud|oppo|vivo\.com|meizu|samsung|apple\.com|icloud|microsoft|windows\.net|mozilla|json\.org|sqlite\.org|zlib|openssl|bouncycastle|slf4j|squareup|kotlinlang|jetbrains|maven|gradle|npmjs|nodejs|jquery|bootstrapcdn|fontawesome|adobe|sil\.org|videolan|khronos|nvidia|wikipedia|ietf\.org|hertzen|chilliant|renebieder|impallari|rfuenzalida|gimp|memtest|ffmpeg|gnu\.org|radb\.net|useplus|mmstat|alicdn|aliyun|aliyuncs|alidns|taobao|alipay|weixin|qq\.com|tencent|wechat|gtimg|myqcloud|bytedance|pangolin|snssdk|toutiao|byteimg|volces|volccdn|volcengine|databyterangers|rangersapplog|sensorsdata|line\.me|kakao|naver|yandex|vk\.com|twitter|linkedin|pinterest|snapchat|reddit|youtube|ytimg|amazon\.com|baidu|bcebos|baidubce|bing\.com|yahoo|live\.com|paypal|stripe|braintree|adyen|razorpay|payu|paytm|phonepe|cashfree|gcash|mynt\.xyz|gcsh\.app|afterpay|forter|zendesk|intercom|helpshift|mixpanel|amplitude|segment\.com|flurry|newrelic|datadog|bugsnag|instabug|signalfx|tapjoy|chartboost|fyber|smaato|criteo|liftoff|moloco|mintegral|kochava|hcaptcha|recaptcha|fengkongcloud|rongcloud|ronghub|rong-edge|netease|126\.net|127\.net|yunxin|sobot|socket\.io|ngrok|appjiagu|crates\.io|verisign|entrust|comodo|globalsign|usertrust|godaddy|geotrust|digicert|sectigo|letsencrypt|public-trust|ocsp|authidv|yuncloudauth|yunverify|cnamedomain|androidplatform\.net'
