...
(custom-theme-set-faces
 ...
 ;; - green :      "#6ac214"
 ;; - orange/red : "tomato"
 `(default ((t (:weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#e5e5e5" :background "#130e24" :stipple nil :inherit nil))))
 `(cursor ((t (:foreground "#222222" :background "#cccccc"))))
