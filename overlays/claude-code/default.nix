# Vendored copy of nixpkgs' claude-code package (pkgs/by-name/cl/claude-code)
# so we can bump claude-code ahead of nixos-unstable. To update, run
# `./update.sh [version]` in this directory to refresh manifest.json, or edit
# manifest.json's version + checksums by hand.
{
  lib,
  stdenvNoCC,
  fetchurl,
